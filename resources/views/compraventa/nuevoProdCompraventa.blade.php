...
                    </div>
                    <input required type="text" class="form-control" name="nombre_producto" value="{{ old('nombre_producto') }}">
                </div>
            </div><br>
        </div>
...
                </div>
                <textarea required class="form-control" name="descripcion_producto" rows="4">{{ old('descripcion_producto') }}</textarea>
            </div>
        </div><br>
        </div>
...
                </div>
                <input required type="text" class="form-control" name="contacto" value="{{ old('contacto') }}">
            </div>
        </div><br>
        </div> 
