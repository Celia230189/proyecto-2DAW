...
// Clase de solicitud personalizada para validar la creación de detalles del carrito de compra
class StoredetallesCarritoCompraRequest extends FormRequest
{
    /**
