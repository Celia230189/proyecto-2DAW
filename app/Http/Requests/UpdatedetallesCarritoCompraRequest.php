...
// Clase de solicitud personalizada para validar la actualización de detalles del carrito de compra
class UpdatedetallesCarritoCompraRequest extends FormRequest
{
    /**
